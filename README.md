...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-leaf-1776)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-leaf-1776
```

A live public deployment of this template is available at [https://frosty-leaf-1776.templates.workers.dev](https://frosty-leaf-1776.templates.workers.dev)
